	...
	return <>
		<div className="d-flex">
			...
			<div className="d-flex justify-content-center elections-selector" style={{ marginLeft: 10 }}>
				<div className="row">
					<div className="col">
						<a href="#" className={`elections-link ${electionGroup === ElectionGroup.IUGA ? "elections-link-active" : ""}`} onClick={() => setElectionGroup(ElectionGroup.IUGA)}>IUGA</a>
					</div>
					{year in WINFO_ELECTIONS && <div className="col">
						<a href="#" className={`elections-link ${electionGroup === ElectionGroup.WINFO ? "elections-link-active" : ""}`} onClick={() => setElectionGroup(ElectionGroup.WINFO)}>WINFO</a>
					</div>}
				</div>
			</div>
		</div>
		...
		<div className="d-flex elections">
			...
			<div className="col-md-9 col-lg-9 col-xl-9">
				...
				<img src={selectedPerson.image} className="election-image" />
