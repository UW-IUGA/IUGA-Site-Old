...
/** 2024 iuga officer images */
import _2024_Sheamin from '../_assets/electionsImages/2024/sheamin_2024_profile.png';
import _2024_Sheamin_info from '../_assets/electionsImages/2024/sheamin_2024.pdf';
import _2024_Akash from '../_assets/electionsImages/2024/akash_2024_profile.png';
import _2024_Akash_info from '../_assets/electionsImages/2024/akash_2024.png';
import _2024_Jada from '../_assets/electionsImages/2024/jada_2024_profile.png';
import _2024_Jada_info from '../_assets/electionsImages/2024/jada_2024.pdf';
import _2024_Cleo from '../_assets/electionsImages/2024/cleo_2024_profile.png';
import _2024_Cleo_info from '../_assets/electionsImages/2024/cleo_2024.png';
import _2024_Brighth from '../_assets/electionsImages/2024/brighth_2024_profile.png';
import _2024_Brighth_info from '../_assets/electionsImages/2024/brighth_2024.pdf';
import _2024_Aradhana from '../_assets/electionsImages/2024/aradhana_2024_profile.png';
import _2024_Aradhana_info from '../_assets/electionsImages/2024/aradhana_2024_info.pdf';
import _2024_Nicole from '../_assets/electionsImages/2024/nicole_2024_profile.png';
import _2024_Nicole_info from '../_assets/electionsImages/2024/nicole_2024.png';
import _2024_Varsha from '../_assets/electionsImages/2024/varsha_2024_profile.png';
import _2024_Varsha_info from '../_assets/electionsImages/2024/varsha_2024.pdf';
import _2024_JR from '../_assets/electionsImages/2024/jr_2024_profile.png';
import _2024_JR_info from '../_assets/electionsImages/2024/jr_2024.pdf';
import _2024_Jonathan from '../_assets/electionsImages/2024/jonathan_2024_profile.png';
import _2024_Jonathan_info from '../_assets/electionsImages/2024/jonathan_2024.pdf';
import _2024_Shirley from '../_assets/electionsImages/2024/shirley_2024_profile.png';
import _2024_Shirley_info from '../_assets/electionsImages/2024/shirley_2024.pdf';
import _2024_Rohan from '../_assets/electionsImages/2024/rohan_2024_profile.png';
import _2024_Rohan_info from '../_assets/electionsImages/2024/rohan_2024.pdf';
import _2024_Kathyrn from '../_assets/electionsImages/2024/kathryn_2024_profile.png';
import _2024_Kathryn_info from '../_assets/electionsImages/2024/kathryn_2024_info.pdf';
import _2024_Iris from '../_assets/electionsImages/2024/iris_2024_profile.png';
import _2024_Iris_info from '../_assets/electionsImages/2024/iris_2024.png';
import _2024_Lomash from '../_assets/electionsImages/2024/lomash_2024_profile.png';
import _2024_Lomash_info from '../_assets/electionsImages/2024/lomash_2024_info.pdf';
import _2024_Michaela from '../_assets/electionsImages/2024/michaela_2024_profile.png';
import _2024_Michaela_info from '../_assets/electionsImages/2024/michaela_2024.png';
...
export const IUGA_ELECTIONS: Elections = {
    ...
    2024: {
		[Officers.PRESIDENT]: [
			{
				name: "Sheamin Kim",
                statement: "Hey iSchoolers! My name is Sheamin and I am thrilled to be running for these year’s IUGA President position. As the last Creative Director, I’ve gotten firsthand experience of what it means to be an IUGA officer, and I want to bring my experiences, insights, and skills into this new leadership position. Because to be a President doesn’t just mean a title- it represents a commitment to excellence and service to those who elected you. The iSchool community is full of amazing people- coders, designers, leaders, researchers, and above all, do-ers. During my time at the iSchool, I’ve seen that Informatics students always strive to put themselves out there and make a difference in their communities, varied though they might be. That kind of drive inspires me, and I know that you deserve not only the best, but my very best effort. And I promise to deliver that. Going into the new year, I aim to re-establish IUGA as the one-stop shop for COMMUNITY and OUTREACH. The purpose of a student organization is to provide resources and opportunities for connection and growth. As president, I would make sure to carefully plan out the entire year, hosting career panels before applications open, holding community bonding events during rough weeks in the quarter, and collaborating with more and diverse organizations on campus. Running with Akash Shrestha as my Vice President, we aim to meet the needs and wants of the student body. Let’s forge connections, new knowledge bases, and set ourselves up for success in this next year together.",
				image: _2024_Sheamin,
				pdf: _2024_Sheamin_info
			},
		],
		[Officers.VICE_PRESIDENT]: [
			{
				name: "Akash Shrestha",
                statement: "Hi everyone! My name is Akash Shrestha. I’m a junior studying Informatics and Political Science and am in my first year as an informatics student. I had the pleasure of being a first-year representative these past two quarters and I have had a lot of fun and excitement helping plan events, working with other RSOs, and getting to know everyone in the Info community! I have decided to run for the vice president position of the Informatics Undergraduate Association because I would like to continue to create and execute great social and professional events to provide our students with opportunities to grow their Info community and professional network. I'd also like to provide more opportunities to branch out and extend our connections with other RSOs to not only give students a great chance to meet other professionals or fellow students but also to learn more about info within different disciplines. Merch is another aspect that students love about Info, so we'll definitely be making some awesome and fresh merch that will surely turn heads around campus! Last but not least, I’d like to incorporate more social events with a larger magnitude back into the IUGA calendar, ideas ranging from past events like iBBQ and iMovie Nights, along with experimenting with new events like iSchool outdoor activities, recruiting events, an iFormal, and even an industry visit to a company or two around Seattle! Being an officer for IUGA, more specifically a vice president would be an honor and a great opportunity to utilize my skillsets and connections to ensure that the iSchool community can continue to flourish. Thank you for taking the time and I am grateful for everyone's consideration of me, I can't wait to see what's to come for us all. Go Dawgs!",
				image: _2024_Akash,
				extraImage: _2024_Akash_info
			}
		],
		[Officers.PUBLIC_RELATIONS]: [
			{
				name: "Jada Nguyen",
                statement: "Hello iWorld! I'm Jada, a second-year Informatics student and I'm thrilled to be running for the position of Director of PR for IUGA! Over the past year, I've witnessed the dedication of our community members in their efforts to enhance IUGA's image and impact within the iSchool community. And recently, my involvement with the IUGA creative committee has given me a fresh perspective on our organization's needs and potential. Running for Director of PR feels like the perfect fit for me! I'm eager to promote more interactivity and encourage more feedback from our students, creating an environment where voices are heard. I'm confident that by leveraging my skills in design and communication, I can make a meaningful difference by refining our online presence and communication strategies. To me, being an officer is more than fulfilling specific responsibilities; it's about embodying leadership, taking initiative, and creating a welcoming environment. I see it as an opportunity to take proactive steps towards positive change and foster inclusivity within our community. I'm genuinely excited about the possibility of serving as your Director of PR and working together to elevate IUGA!",
				image: _2024_Jada,
				pdf: _2024_Jada_info
			}
		],
		[Officers.OUTREACH]: [
			{
				name: "Cleo Reyes",
                statement: "Hey there, my name is Cleo. I am honored to be nominated for Director of Outreach. As a first-year direct admit to Informatics, I had the pleasure and privilege of being immersed in the iSchool from day one. Given this amazing opportunity, I have been able to meet so many amazing, talented, driven, and intelligent individuals who make up this phenomenal community. I made the most of this opportunity by connecting and getting to know my peers and faculty understanding the diversity that encapsulates our community and utilizing the resources available to students to work on my professional development. I am running to be your next Director of Outreach because I want to foster meaningful connections for students whether that be with peers, alumni, companies, or organizations. Having seen what the students of Informatics have to offer, I believe in each student's potential making me want to give back. I want to host workshops where students can learn more about professional development and develop the skills necessary to navigate their paths no matter what stage of the process they might be in. Whether that be searching for internships, writing their resumes and cover letters, creating and using their LinkedIn, or how to prepare for interviews. Additionally, I would like to continue and expand the networking events with companies affiliated with the iSchool but I would also like to reach out to new companies and alumni to diversify the network students can build and seek out opportunities. Most importantly, being part of the officer board I listen to student feedback. Your voices, your ideas, and your concerns are what drive this community forward. As Director of Outreach, I would be honored to serve my community with dedication, passion, and an unwavering commitment to amplifying your voices and addressing your needs.",
				image: _2024_Cleo,
				extraImage: _2024_Cleo_info
			},
            {
				name: "Bright Hoang",
                statement: "Hi, iSchool! My name is Bright, and I am running for the IUGA 2024-2025 Director of Outreach role! This last year and a half at the iSchool has been a joyous and exhilarating roller coaster filled with valuable learning experiences, academic gatherings, and, my favorite part of all, meeting and conversing with all the brilliant minds of the iSchool! Having the opportunity to speak with such a diverse cohort opened my eyes to everyone’s different learning styles, cultural and personal backgrounds, and shared struggles of being a scholar in informatics. This includes things like a lack of internship awareness, lack of UX design curriculums and courses, how hard it is to find a field of interest, etc. As Director of Outreach, I aim to connect with as many informatics students as possible to learn about their individualized struggles— broadening IUGA’s reach and impact. I am beyond grateful for this opportunity and I am 100% committed to creating a larger, positive shift in the Informatics Undergraduate program.",
				image: _2024_Brighth,
				pdf: _2024_Brighth_info
			},
            {
				name: "Aradhana Muthabatulla",
                statement: "Hello! My name is Aradhana Muthabatulla and I am a current sophomore majoring in Informatics. A bit about me is that I play soccer for the UW women's club team and I am a member of Kappa Delta! I love Informatics because it is such a broad and diverse field with boundless opportunities. I'm running for the Director of Outreach position because I want to connect students within this major and showcase the amazing opportunities that are available to Informatics students! As a freshman, I was not familiar with the incredible resources that the iSchool has to offer. Without a solid network within my major, I was not aware of the events that I could attend or the opportunities that I could pursue. Looking back, I realize how much easier my journey would have been with the support of IUGA. That's why I'm determined to bring awareness to this invaluable community. IUGA is the perfect place for both new and existing Informatics students to form connections, access resources, build friendships, and create a stable support system that can profoundly impact their careers. I am running for the Director of Outreach because I see the impact that the IUGA can have on students navigating their college journey. I want to host engaging events and create a welcoming atmosphere in order to attract more students and showcase the incredible opportunities that await them. In addition to bringing in new members, I plan on enriching the experiences of those already here through more career-oriented events to combine faculty and alumni with the student body in order for networking and development. This will increase collaboration within our community, opening doors to exciting internship and job prospects, as well as expanding academic opportunities for students to thrive. I am committed to fostering a community where every student feels supported, engaged, and empowered to thrive within this field. I’d love your support and vote as I strive to make IUGA even better! I am so excited to meet everyone and have a positive impact on the informatics community at UW!",
				image: _2024_Aradhana,
				pdf: _2024_Aradhana_info
			}
		],
		[Officers.FINANCE]: [
			{
				name: "Nicole Chen",
                statement: "Hi everyone! I’m Nicole, and I’m excited to be running to be your next Director of Finance. As a freshman, I’ve really enjoyed how iSchool students are all connected and the sense of community we all foster. Attending IUGA events the past two quarters and connecting with iSchool upperclassmen has motivated me to run for Director of Finance as I’m passionate about the organizational and financial aspects of our communities, and love event planning. I believe that all organization, especially financial, starts from ground up. As the lead organizer of TEDxYouth@SahaleeRoad, I was able to lead a team of local students to organize a completely self-sufficient conference with over 60k views. I’ve also planned events like UW Formula Motorsport’s Silent Auction and been heavily involved in sponsorship outreach and fundraiser organization. With these experiences, I’m excited to organize events that take your ideas into consideration. Working directly with your peers and faculty, I’m excited to bring a top-level lens to how we can leverage funds to be the best IUGA for you. I’m committed to ensuring that funds are efficiently and properly managed and allocated through decision making and planning from all perspectives, as well as how we can maximize our budget for everyone. My ability in organizing events and funds stems from enthusiasm to connect the communities I’m passionate about, such as the iSchool, and I would be honored to have your vote. Thank you for your consideration!",
				image: _2024_Nicole,
				extraImage: _2024_Nicole_info
			},
			{
				name: "Varsha Bharath",
                statement: "My name is Varsha Bharath and as an IUGA first-year rep and WINFO creative committee chair, I have experience not only within the IUGA board already but also within WINFO as well. The one thing I believe makes me the best for the role of Director of Finance is that as FYR, I’m already aware of how IUGA functions. From posing an event idea to making the room reservation, I come in with a bit of a head start in knowledge. I believe this information will make me a quicker study as well as a natural presence on the IUGA board. From WINFO, I learned a lot about interpersonal skills as well as event planning, skills I think are essential in the IUGA board. I’d love to merge the skills I gathered from both teams and display them in my chosen role of Director of Finance. I chose this role because I understand that at the end of the day, funding is the best way to show the info community that we care about their interests, and inclusivity is one of my personal mantras I live by. While I love to express my creative side in coming up with event ideas and decoration, at my core I am someone who thrives on logic and rigidity, which is why handling the finances for IUGA seems like the best fit for me. I am pretty strong in math (went up to calc 2 and stats) and also have a ton of experience with Excel/Google Sheets. I also used to run a nonprofit in high school where I handled around $10000 in the business bank account.",
                image: _2024_Varsha,
                pdf: _2024_Varsha_info
			},
            {
				name: "J.R. Lim",
                statement: "Hey everyone! I’m J.R. Lim and I’m running to be your next Director of Finance! I am a third-year student, double majoring in Informatics and Geography, and minoring in History. Within the iSchool, I have served as a Teaching Assistant for the past 2 years, serving under Dr. Odumosu in INFO498 and Dr. Kotut in INFO415, as well as a Research Assistant in Dr. Yip’s KidsTeam. In addition, I am currently the Treasurer for the Filipino American Student Association (FASA sa UW), as well as a Sales Representative at the IMA, gaining vital experiences in financials and budgeting! I will be successful as IUGA’s next Director of Finance based on the aforementioned experiences, as well as the skills I’ve been able to improve on along the way. As FASA’s Treasurer, I’ve had the ability to oversee all budgeting and event planning aspects of the RSO, as I handle over $50,000 in financial assets! I’ve also helped organize numerous fundraising efforts with UW Athletics, collectively generating over $6,000 in revenue, as well as being approved for various grants, totalling $4,000, from the ASUW, HUB, and CHID departments. By working closely with multiple faculty within the Ethnic Cultural Center and Student Activities Office, I have learned how to efficiently minimize unnecessary expenses when considering events, while still maximizing entertainment and member engagement. As Director of Finance, I will ensure that all opportunities presented by IUGA will be accessible to all of you guys! Whether it’s maintaining affordable merchandise prices or offering programming events, inclusivity will be at the forefront of my service. I thank you for your time and consideration and hope to receive your vote!",
                image: _2024_JR,
                pdf: _2024_JR_info
			}
		],
		[Officers.DIVERSITY]: [
			{
                ...
                statement: "Hi everyone! My name is Jonathan H. Ortiz-Candelaria and I’m excited to be running for Director of Diversity Efforts for IUGA. I am a third year here at the University of Washington and recent addition to the iSchool, having gotten in this winter quarter. I am originally from Puerto Rico and lived there until I was 15 when I moved to Washington. Through this transition, I have understood firsthand how important it is to have people of similar backgrounds to yourself around you. This leads to more comfortable and empowering spaces. This is why I decided to get involved in the field of diversity in higher education. Last year, I served as a Louis Stoke’s Alliance for Minority Participation (LSAMP) student ambassador where I educated undergraduate STEM students in the resources the office provides to advance their undergraduate and postgraduate plans. This year, I am an Academic Counseling Services (ACS) peer advisor with the Office of Minority Affairs and Diversity (OMA&D) where I support undergraduate students with personal and academic questions in navigating university life here at UW. I hope to draw from these experiences in order to further the iSchool’s commitment to inclusion, diversity, equity, access, and sovereignty (IDEAS).  As IUGA Director for Diversity Efforts, I would want to continue efforts of collaborating with other RSO’s; even expanding to others past Informatics related clubs. Fostering a community not just within the Informatics major, but in the university as a whole. I would also like to work with offices and spaces around campus (such as OMA&D) to promote the iSchool to more minority students in order to continue increasing diversity in our major.",
                image: _2024_Jonathan,
                pdf: _2024_Jonathan_info
			},
            {
				name: "Lomash Sharma",
                statement: "Hello iSchoolers, I'm Lomash! Having actively contributed to IUGA's Diversity & Community Relations committee since its inception, I am thrilled to declare my candidacy to be your next Director of Diversity Efforts! I am an international freshman direct-admit to the Informatics major, eager to explore PM and bio-medical info with an intended minor in Nutrition. From the outset, the informatics community has provided me with unwavering support and a safe space. When I think of diversity, I envision a tapestry of varied experiences, cultures, and perspectives weaving together to form a stronger and more vibrant community. My own multilingual background and multicultural heritage have profoundly shaped my worldview, enabling me to make meaningful connections at the iSchool. In my current role on the Diversity and Community Relations Committee, I have been dedicated to foster an inclusive and equitable environment within IUGA and beyond. Collaborating with student organizations such as Winfo, iQueeries, Binfo, and UX@UW, I have organized events aimed at promoting inclusion and diversity. I am committed to advancing IDEAS (Inclusion, Diversity, Equity, Access & Sovereignty) within the iSchool and the broader UW community. I am excited to bring my passion for diversity and my expertise in community engagement to the role of Director of Diversity Efforts. Let's continue to cultivate a warm and inclusive environment for everyone in our iSchool community! Thank you for your consideration :)",
                image: _2024_Lomash,
                pdf: _2024_Lomash_info
			},
		...
		[Officers.CREATIVE]: [
			{
				name: "Shirley Yun",
				image: _2024_Shirley,
				pdf: _2024_Shirley_info,
                statement: "Hey everyone! My name is Shirley. I'm a 2nd year Informatics student and I'm honored to run as your potential next IUGA Creative Director. The iSchool has been incredibly welcoming and the hard working, driven community has been so inspiring I want to be able to give back to you all as Creative Director. In my past, I've been in multiple creative, design-oriented positions. Specifically, my experience designing for HOMEROOM, The Kompany, and most importantly, IUGA itself gave me tons of insight into the ins and outs of merchandise management, design, and working creatively with amazingly talented groups of people. Alongside school related projects, myself and a collaborator have worked on hosting and designing cupsleeve events in Seattle for some of your guys' favorite Kpop groups, from managing stock, promoting the event, and designing the merch itself, I've gained tons of experience within the more logistical side of turning creative and fun ideas into a tangible product! Outside of school, you can either find me trapped in the IMA dancing for The Kompany or somewhere in Seattle, wandering around with friends looking for a good meal. As your Creative Director, I hope to not only help turn the opinions of the students into a reality, but I also want to be a reliable resource for you all to be able to represent your school proudly. The iSchool is filled with incredibly skilled, and talented individuals and I will put my best effort to represent you all as IUGA's Creative Director :)"
			}
		],
        [Officers.IT]: [
			{
				name: "Rohan Simha",
				image: _2024_Rohan,
				pdf: _2024_Rohan_info,
                statement: "Hello fellow Huskies, I’m Rohan Simha, and I’m aspiring to be your next Director of Information Technology for the Informatics Undergraduate Association. As I reflect on my journey through the Informatics program, I realize it’s the intersections of technology, community, and innovation that ignite my passion. I'm not just a student with a solid GPA and technical know-how; I am one of you, eager to build a connected and dynamic community through the power of tech. Why am I running for this position? Because I believe in the transformative power of technology not just to solve problems, but to bring us together. Whether it's hosting Game Nights or ensuring our online assets are top-notch, I see technology as an enabler, a connector, and a force for positive change. My experience as a Co-President of the Technology Student Association taught me that leadership isn’t just about expertise; it’s about listening, understanding, and acting in service of others. I want to bring that thought process to the role of Director of IT. From maintaining our websites to managing our gaming servers, I see these tasks as more than just duties—they are opportunities to enrich our Informatics experience, together. What does being an officer mean to me? It's an honor and a responsibility. It means being a voice for you, leveraging every line of code and every pixel on the screen to support our collective aspirations. It’s about ensuring that every student feels empowered and equipped to succeed in their academic and professional endeavors. I'm here to support you, to serve you, and to create with you. Let’s not just anticipate the future of technology in Informatics—let’s shape it together. Vote for Rohan Simha, and let’s turn our visions into reality!"
			},
            {
				name: "Michaela Tran",
				image: _2024_Michaela,
				extraImage: _2024_Michaela_info,
                statement: "Hi everyone, I'm Michaela Tran! I'm a third-year Informatics student running for your IUGA Director of IT for the 2024-2025 year! I'm currently a part of the Diversity Committee, and I've enjoyed contributing to IUGA by helping with events and learning about what we can do to improve our iSchool student experience. I'm looking forward to playing a greater role in IUGA as the Director of IT for the upcoming year! Being a part of the INFO program has been one of the most rewarding experiences I've had at UW. It's allowed me to meet some of my closest friends, genuinely connect with people with similar interests, meet industry professionals in more casual settings such as panels and events, and explore different sectors of information technology. I'm excited to give back to IUGA and the iSchool and challenge myself as the Director of IT. I plan to maintain the new website and incorporate student feedback throughout the year. I also plan to work closely with iSchool IT to meet student technology needs and find solutions to our technology issues. Lastly, I plan to collaborate with other tech-oriented RSOs on workshops or tech-related events to foster more community. Being an IUGA officer assumes much responsibility and representation for the iSchool students. It also means completing clear goals and tasks to support the club and the iSchool as a whole while supporting other officers when needed. I look forward to supporting you all and the other officers as your Director of IT! Thank you for considering me!"
			}
		],
        [Officers.ACADEMIC]: [
			{
				name: "Kathryn Rochleau-Rice",
				image: _2024_Kathyrn,
				pdf: _2024_Kathryn_info,
                statement: "Hello, my name is Kathryn Rochleau-Rice and I would be honored to be your Director of Academic Support. As a Direct-Admit, I feel strongly connected to the iSchool community and hope to use my position to amplify the voices of my peers. I have experience with advocacy work, bridging communication between students and staff from my time as a Diversity & Inclusion Program Leader at my dance studio. I am a proactive leader passionate about intentional engagement and initiating individual connections to strengthen communities. I believe in the diverse and interdisciplinary program that Informatics has to offer, and I’d love to gain a tangible role in helping others achieve their academic goals. The college prides itself on the collaboration of people and ideas, creating space for students to learn from one another. Academic success isn’t only about getting good grades, it encompasses the success of students as a whole. I aim to reflect this in my role, encouraging growth through opportunities in and outside of the academic space. With my experience in leading, organizing, and facilitating collaborative events as president of both All That Dance’s chapter of National Honors Society for Dance Arts and Fashion Club, I can confidently say that I am equipped to not only support current and future iSchool students’ academic experiences, but enhance them. I want to make IUGA more accessible for students by clarifying and centralizing resources. When people ask: ‘What even is Informatics? What can you do with it?’, which they always do, I want students to feel proud answering what Informatics is to them and encourage their confidence when it comes to pursuing their goals. If given this opportunity, I would take on an active role in supporting a community I care deeply about. Thank you for your consideration!"
			},
            {
				name: "Iris Hamilton",
				image: _2024_Iris,
				extraImage: _2024_Iris_info,
                statement: "Hello! I’m Iris Hamilton, a 3rd year junior double degreeing in Informatics and Biology. I’m passionate about community growth and development and have committed to take on leadership and mentoring roles in my community to contribute to that vision. I remember being in my second year at UW and still being confused on what I wanted to do with Biology. By chatting with peers, I learned about the field of Information and how we as a society can use it to improve and develop our visions to life! Coming from a Biology background, I’ve been able to integrate my love for lab science, data science, and design into a path that has led to solid community development and impacts! These efforts came to be with the Informatics community and peers I spoke to that urged me to explore. I’d like to provide similar opportunities for iSchool students to explore and find something they’re also passionate. Demystifying industries, providing academic resources for quality learning, and consistent skill development are ideas I’d like to implement through my role as the Director of Academic Support. I’d like to put on workshops, Q+A panels, and other explorative events to provide students with different resources to aid their learning. We grow by exposing ourselves to new ideas and thus, I’d like students to try their hand at new ideas in a safe supportive environment. I’ve had extensive experience providing resources to students through research mentoring and event coordinating and am confident in my abilities to provide these experiences to students. Hearing what resources students need to achieve their goals is what I will emphasize on to ensure that learning needs of students are met. I’m excited to contribute to such a diverse student body and look forward to nurturing student growth!"
			}
		]
	}
}
